...
const Benefits: React.FC<BenefitsProps> = ({ onRedirect }) => {
  ...
  return (
    <section id="beneficios" className="py-8 md:py-16 bg-purple-900">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {benefits.map((benefit, index) => (
            <div 
              key={index} 
              className="bg-purple-800 rounded-xl p-4 md:p-6 shadow-md border border-purple-600 hover:shadow-lg transition-shadow duration-300"
            >
        ...
        <div className="text-center mt-8 md:mt-12">
          ...
          <p className="text-sm text-gray-400 mt-2">✅ Sem consulta ao SPC • ✅ Frete grátis • ✅ Ativação em 24h</p>
        </div>
      </div>
    </section>
  );
