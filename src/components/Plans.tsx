    ...
    <section id="planos" className="py-6 md:py-12 bg-black">
      <div className="container mx-auto px-4">
        <div className="text-center mb-6 md:mb-10">
          ...
          <div className="bg-gray-800 rounded-xl p-6 md:p-8 mb-8 max-w-4xl mx-auto border border-gray-600">
            <div className="text-center mb-6">
              <h3 className="text-xl md:text-2xl font-bold text-white mb-4">
                🤔 Por que existem vários planos diferentes na Federal Associados se a internet é ilimitada?
              </h3>
              <p className="text-base md:text-lg text-gray-300 leading-relaxed">
                Aqui na Federal Associados, <strong className="text-white">você nunca fica sem internet</strong>. Todos os planos possuem navegação ilimitada, o que muda é a <strong className="text-white">velocidade e a experiência</strong> que você deseja.
              </p>
            </div>

            <div className="text-left mb-6">
              <h4 className="text-lg font-bold text-white mb-4 text-center">Veja como funciona:</h4>
              <div className="space-y-3">
                <div className="bg-gray-700 rounded-lg p-4 border border-gray-600">
                  <div className="flex items-center mb-2">
                    <span className="bg-gray-600 text-white rounded px-2 py-1 text-sm font-bold mr-3 min-w-[50px] text-center">40GB</span>
                    <span className="text-white font-semibold">Uso Básico</span>
                  </div>
                  <p className="text-gray-300 text-sm ml-16">Redes sociais, mensagens, navegação leve</p>
                </div>

                <div className="bg-gray-700 rounded-lg p-4 border-2 border-blue-500 relative">
                  <div className="absolute -top-2 -right-2 bg-blue-500 text-white text-xs font-bold px-2 py-1 rounded">
                    Mais Escolhido
                  </div>
                  <div className="flex items-center mb-2">
                    <span className="bg-blue-500 text-white rounded px-2 py-1 text-sm font-bold mr-3 min-w-[50px] text-center">80GB</span>
                    <span className="text-white font-semibold">Uso Completo</span>
                  </div>
                  <p className="text-gray-300 text-sm ml-16">Vídeos, home-office, estudos, jogos</p>
                </div>

                <div className="bg-gray-700 rounded-lg p-4 border border-gray-600">
                  <div className="flex items-center mb-2">
                    <span className="bg-gray-600 text-white rounded px-2 py-1 text-sm font-bold mr-3 min-w-[50px] text-center">150GB</span>
                    <span className="text-white font-semibold">Uso Familiar</span>
                  </div>
                  <p className="text-gray-300 text-sm ml-16">Wi-Fi família, roteador, modem, TV</p>
                </div>

                <div className="bg-gray-700 rounded-lg p-4 border border-gray-600">
                  <div className="flex items-center mb-2">
                    <span className="bg-gray-600 text-white rounded px-2 py-1 text-sm font-bold mr-3 min-w-[50px] text-center">200GB+</span>
                    <span className="text-white font-semibold">Uso Profissional</span>
                  </div>
                  <p className="text-gray-300 text-sm ml-16">Empresas, equipes, uso intenso</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-700 border border-gray-500 rounded-lg p-4 text-center">
              <p className="text-white font-semibold">
                💡 <strong>Resumindo:</strong> Todos os planos realmente têm internet ilimitada, o que muda é a <strong>velocidade e a finalidade</strong> de cada um!
              </p>
            </div>
          </div>
