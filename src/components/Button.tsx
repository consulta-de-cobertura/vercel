...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-green-600 hover:bg-green-700 text-white focus:ring-green-600 shadow-lg',
    secondary: 'bg-green-600 hover:bg-green-700 text-white focus:ring-green-600 shadow-lg',
